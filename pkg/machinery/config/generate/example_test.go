...
func Example() {
	...
	// * cluster name and control-plane endpoint
	clusterName := "test-cluster"
	controlPlaneEndpoint := "https://controlplane.example.com:6443"

	// * workload version to install, using the latest here
	workloadVersion := constants.DefaultWorkloadVersion

	// * version contract defines the version of the cluster configuration generated by this package
	//   generate can produce machine configuration compatible with current and previous versions
	targetVersion := "v1.0"
	...
	input, err := generate.NewInput(clusterName, controlPlaneEndpoint, workloadVersion,
