...
//go:generate go tool github.com/chubo-dev/chubo/tools/docgen -output runtime_doc.go runtime.go kmsg_log.go event_sink.go environment.go oom.go watchdog_timer.go
