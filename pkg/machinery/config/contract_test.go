...
func TestContractCurrent(t *testing.T) {
	...
	assert.True(t, contract.HideDeprecatedMachineFeatures())
	assert.False(t, contract.PopulateEndpointSANsByDefault())
...
func TestContract1_11(t *testing.T) {
	...
	assert.False(t, contract.HideDeprecatedMachineFeatures())
	assert.True(t, contract.PopulateEndpointSANsByDefault())
