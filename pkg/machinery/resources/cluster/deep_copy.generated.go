...
// Code generated by "deep-copy -type AffiliateSpec -type ConfigSpec -type ControlPlaneEndpointSpec -type IdentitySpec -type MemberSpec -type InfoSpec -header-file ../../../../hack/boilerplate.txt -o deep_copy.generated.go ."; DO NOT EDIT.
...
// DeepCopy generates a deep copy of ControlPlaneEndpointSpec.
func (o ControlPlaneEndpointSpec) DeepCopy() ControlPlaneEndpointSpec {
	var cp ControlPlaneEndpointSpec = o
	if o.Addresses != nil {
		cp.Addresses = make([]netip.Addr, len(o.Addresses))
		copy(cp.Addresses, o.Addresses)
	}
