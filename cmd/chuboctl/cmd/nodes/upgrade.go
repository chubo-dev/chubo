...
import (
	...
	"github.com/chubo-dev/chubo/cmd/chuboctl/pkg/nodes/action"
...
func init() {
	...
	upgradeCmd.Flags().BoolVarP(&upgradeCmdFlags.force, "force", "f", false, "force the upgrade (skip control-plane safety checks, might lead to data loss)")
