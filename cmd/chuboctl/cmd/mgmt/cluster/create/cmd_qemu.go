...
import (
	...
	"github.com/chubo-dev/chubo/cmd/chuboctl/cmd/constants"
	"github.com/chubo-dev/chubo/cmd/chuboctl/cmd/mgmt/cluster/create/clusterops"
	"github.com/chubo-dev/chubo/cmd/chuboctl/cmd/mgmt/cluster/create/clusterops/configmaker/preset"
...
func init() {
	...
	addOSVersionFlags(commonFlags, &cOps.ChuboVersion, "the desired Chubo OS version")
