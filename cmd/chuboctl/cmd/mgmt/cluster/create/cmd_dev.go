...
import (
	...
	"github.com/chubo-dev/chubo/cmd/chuboctl/cmd/mgmt/cluster/create/flags"
...
func getCreateCmd(cmdName string, hidden bool) *cobra.Command {
	...
	getCommonFlags := func() *pflag.FlagSet {
		...
		addOSVersionFlags(common, &cOps.ChuboVersion, "the desired Chubo OS version to generate config for")
