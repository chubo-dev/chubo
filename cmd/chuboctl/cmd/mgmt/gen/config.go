...
// GenerateConfigBundle generates the Chubo OS config bundle
//
...
func init() {
	...
	genConfigCmd.Flags().BoolVarP(&genConfigCmdFlags.withClusterDiscovery, "with-cluster-discovery", "", false, "enable experimental external cluster discovery")
