...
var rules = map[string]role.Set{
	...
	"/machine.MachineService/NomadConfig":                 role.MakeSet(role.Admin),
	"/machine.MachineService/ConsulConfig":                role.MakeSet(role.Admin),
	"/machine.MachineService/OpenBaoConfig":               role.MakeSet(role.Admin),
