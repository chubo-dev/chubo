...
func TestGenerateNextUKIFileName(t *testing.T) {
	...
	for _, testData := range []struct {
		...
		},
		{
			...
			version:          "1.11.0",
			existingFiles:    []string{"Talos-1.10.0.efi"},
			expectedFileName: "Chubo-1.11.0.efi",
		},
		{
		...
		{
			name:             "mixed_chubo_and_legacy_files",
			version:          "1.10.0",
			existingFiles:    []string{"Chubo-1.10.0.efi", "Talos-1.10.0~1.efi"},
			expectedFileName: "Chubo-1.10.0~2.efi",
		},
		{
			...
			expectedFileName: "Chubo-v1.11.0-alpha.3-40-ge4c24983e-dirty~1.efi",
		},
		{
			...
			expectedFileName: "Chubo-v1.11.0-alpha.3-40-ge4c24983e-dirty~2.efi",
		},
	} {
...
func TestFindMatchingUKIFile(t *testing.T) {
	...
	existingFiles := []string{
		"/EFI/boot/Linux/Chubo-1.10.0.efi",
		"/EFI/boot/Linux/Chubo-1.10.0~1.efi",
		"/EFI/boot/Linux/talos-1.11.0.efi",
		"/EFI/boot/Linux/Talos-v1.11.0-alpha.3-40-ge4c24983e-dirty.efi",
		"/EFI/boot/Linux/Chubo-v1.11.0-alpha.3-40-ge4c24983e-dirty~1.efi",
	}
	...
	tests := []struct {
	...
	}{
		{
			...
			entry:          "Chubo-1.10.0.efi",
			expectedFile:   "Chubo-1.10.0.efi",
			expectingFound: true,
		},
		{
			existingFiles:  existingFiles,
		...
		{
			existingFiles:  existingFiles,
			entry:          "Chubo-v1.11.0-alpha.3-40-ge4c24983e-dirty~1.efi",
			expectedFile:   "Chubo-v1.11.0-alpha.3-40-ge4c24983e-dirty~1.efi",
			expectingFound: true,
		},
		{
