...
var (
	// Indicates the Chubo OS version when this deprecated message will be removed from API.
	//
...
var (
	// Indicates the Chubo OS version when this deprecated field will be removed from API.
	//
...
var (
	// Indicates the Chubo OS version when this deprecated enum will be removed from API.
	//
...
var (
	// Indicates the Chubo OS version when this deprecated enum value will be removed from API.
	//
...
var (
	// Indicates the Chubo OS version when this deprecated method will be removed from API.
	//
...
var (
	// Indicates the Chubo OS version when this deprecated service will be removed from API.
	//
