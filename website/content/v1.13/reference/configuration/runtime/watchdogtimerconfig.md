...
{{< /highlight >}}</details> | |
|`timeout` |Duration |Timeout for the watchdog.<br><br>If Chubo is unresponsive for this duration, the watchdog will reset the system.<br><br>Default value is 1 minute, minimum value is 10 seconds.  | |
